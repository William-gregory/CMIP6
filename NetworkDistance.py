...
def Dist(strengthmap1,strengthmap2,seed=1):
  ...
  measure between two complex networks (Fountalis et al 2015).
  The two inputs,'strengthmap1' and 'strengthmap2' are assumed
  to be both 2D arrays where each grid cell contains the 
